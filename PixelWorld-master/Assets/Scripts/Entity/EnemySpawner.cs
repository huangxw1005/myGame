...
public class EnemySpawner : MonoBehaviour {
	...
	public int[] monsterList; //monster list to spawn
	...
	{		
		...
		randomRadius = Random.Range (0, areaSpawn);
		randomSpawnVector.x = Mathf.Sin(randomAngle) * randomRadius + transform.position.x;
		randomSpawnVector.z = Mathf.Cos(randomAngle) * randomRadius + transform.position.z;
